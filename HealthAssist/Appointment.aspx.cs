...
namespace HealthAssist
{
    public partial class Appointment : System.Web.UI.Page
    {
        ...
        protected void CreateEncounter_ServerClick(object sender, EventArgs e)
        {
            Response.Redirect("PatientNewEncounter.aspx?id=");
        }

        
        protected void AddClick(object sender, EventArgs e)
        {
            Response.Redirect("AppointmentDetail.aspx?id=");
        }
        ...
        protected void UpdateClick(object sender, EventArgs e)
        {
            ...
            string patientNo = gvList.Rows[gvrow.RowIndex].Cells[1].Text;
            Response.Redirect(String.Format("AppointmentDetail.aspx?id={0}&patientNo={1}", Server.UrlEncode(id), Server.UrlEncode(patientNo)));
        }
    }
}