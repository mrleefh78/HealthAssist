<%@ Page Title="" Language="C#" MasterPageFile="~/BrightCareAdmin.Master" AutoEventWireup="true" CodeBehind="PatientNewCase.aspx.cs" Inherits="HealthAssist.PatientNewCase" EnableEventValidation="false"%>
         ...
         <div class="row">  
             ...
             <div class="col-md-3"> 
                  <form class="form-inline my-2 my-lg-0">
                   ...
                   <p>Reference No.</p>
                  <input id="RefNo" runat ="server"  class="form-control mr-sm-2" type="text" placeholder="Case No" readonly/>
                   <p>Date</p>
                     <input id="CaseDate" runat ="server" class="form-control mr-sm-2" type="text" placeholder="Case Date" readonly/>
                  ...
                  <p>Assistance Company</p>
                      <asp:DropDownList ID="ddlCompany" class="form-control mr-sm-2" runat="server"></asp:DropDownList>
                        <button type="button" id="AddInsuranceCompanyButton"  title="Add Physician" onserverclick="AddInsuranceCompanyClick"  runat ="server" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-plus"></span></button>             
                  ...
                  <p>Health Facility</p>
                       ...
                       <button type="button" id="addFacilityButton"  title="Add Physician" onserverclick="AddHospitalClick"  runat ="server" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-plus"></span></button>             
                 ...
                 <form class="form-inline my-2 my-lg-0">
                  ...
                  <p>Date Discharged</p>
                   ...
                   <asp:DropDownList ID="ddlPhysician" class="form-control mr-sm-2" runat="server"></asp:DropDownList>   
                      <button type="button" id="addPhysicianButton"  title="Add Physician" onserverclick="AddPhysicianClick"  runat ="server" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-plus"></span></button>             
