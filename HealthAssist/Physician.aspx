<%@ Page Title="" Language="C#" MasterPageFile="~/BrightCareAdmin.Master" AutoEventWireup="true" CodeBehind="Physician.aspx.cs" Inherits="HealthAssist.Physician" EnableEventValidation="false"%>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderHeader" runat="server">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><asp:Label ID="ActiveForm" runat="server" Text="Physicians"></asp:Label></li>
      </ol>
    </section>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="modal-content">
        ...
        <h4 class="modal-title custom_align" id="Heading1">Reason for deletion </h4>
         ...
         <p> Are you sure to delete physician <asp:Label ID="lblSelectedItem" runat="server" ClientIDMode ="Static" ></asp:Label> ? </p> <asp:HiddenField ID="HiddenFieldPatient" ClientIDMode ="Static" runat="server" />
