...
namespace HealthAssist.AppDal
{
    public class PatientDAL : BaseDAL 
    {
        ...
        public DataSet SelectAllPatient()
        {
            ...
            strSql = "SELECT * " +
                     "FROM " + TABLE_PATIENT + "  WHERE IFnull(IsDeleted,0) = 0 ";
        ...
        public DataSet SeachPatient(string keyword)
        {
            ...
            strSql = "SELECT *  " +
                     "FROM " + TABLE_PATIENT + " Where 1=1 and IsDeleted = 0 ";
        ...
        public void InsertPatient(string currUser, PatientModel oClass)
        {
            strSql = "Set @PatientNo = (SELECT Concat('PT',CAST(DATE_FORMAT(curdate(),'%Y%m') AS CHAR(6)), '0001')); " +
                     "Set @LastPatientNo = (SELECT Concat('PT', Cast(right(PatientNo,10) + 1 AS CHAR(10))) From " + TABLE_PATIENT + " " +
            ...
            strSql = strSql + "INSERT INTO " + TABLE_PATIENT + " (" +
                        COLUMN_PATIENT_NO + ", " +
                        COLUMN_DATE_REG + ", " +
                        COLUMN_LASTNAME + ", " +
                        COLUMN_FIRSTNAME + ", " +
