<%@ Page Title="" Language="C#" MasterPageFile="~/PhysicianMain.Master" AutoEventWireup="true" CodeBehind="MyPatients.aspx.cs" Inherits="HealthAssist.MyPatients" EnableEventValidation="false"%>
            ...
            <Columns>
                ...
                <asp:TemplateField>
                    ...
                    <%--    <asp:ImageButton ID="btnEdit" runat="server" CommandName="EditCommand" class="btn btn-success" Text="Edit" ToolTip="Edit" />--%>
                        <button type="button" id="updateButton" title="View Details" data-id ='<%# Eval("id")%>' onserverclick="UpdateClick"  runat ="server"  class="btn btn-success btn-xs" data-toggle="modal" data-target="#edit"><span class="glyphicon glyphicon-edit"></span></button>
