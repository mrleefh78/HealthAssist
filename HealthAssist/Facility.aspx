<%@ Page Title="" Language="C#" MasterPageFile="~/BrightCareAdmin.Master" AutoEventWireup="true" CodeBehind="Facility.aspx.cs" Inherits="HealthAssist.Facility" EnableEventValidation="false"%>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderHeader" runat="server">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><asp:Label ID="ActiveForm" runat="server" Text="Healthcare Facilities"></asp:Label></li>
      </ol>
    </section>
</asp:Content>
    ...
    <div class="container-fluid" style="margin: 0">
        ...
        <div class="table-responsive">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="DateAccredit" HeaderText="Accreditation Date" DataFormatString="{0:d}" />
                  <asp:BoundField DataField="DateExpire" HeaderText="Accreditation Expiration Date" DataFormatString="{0:d}" />
