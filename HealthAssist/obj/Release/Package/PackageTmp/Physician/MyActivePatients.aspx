<%@ Page Title="" Language="C#" MasterPageFile="~/PhysicianMain.Master" AutoEventWireup="true" CodeBehind="MyActivePatients.aspx.cs" Inherits="HealthAssist.MyActivePatients" EnableEventValidation="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderHeader" runat="server">
    <section class="content-header">
      <h1>
        Patients
        <small>List of my Patients</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="Dashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"><asp:Label ID="ActiveForm" runat="server" Text="My Patients"></asp:Label></li>
      </ol>
    </section>
</asp:Content>
    ...
    <div class="container-fluid" style="margin: 0">
        ...
        <div class="table-responsive">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="EncounterNo" HeaderText="Encounter Number">
                <HeaderStyle HorizontalAlign="Left" />
                <ItemStyle Width="100px" />
                </asp:BoundField>
                <asp:BoundField DataField="EncounterDate" DataFormatString="{0:d}" HeaderText="Encounter Date">
                <HeaderStyle HorizontalAlign="Left" />
                ...
                <asp:TemplateField>
                    ...
                    <%--    <asp:ImageButton ID="btnEdit" runat="server" CommandName="EditCommand" class="btn btn-success" Text="Edit" ToolTip="Edit" />--%>
                        <button type="button" id="updateButton" title="Start Consultation" data-id ='<%# Eval("id")%>' onserverclick="UpdateClick"  runat ="server"  class="btn btn-success btn-xs" data-toggle="modal" data-target="#edit"><span class="glyphicon glyphicon-edit"></span></button>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <button type="button" id="deleteID" title="Cancel" class="btn btn-danger btn-xs"data-toggle="modal" data-target="#delete"  data-id ='<%# Eval("id")%>' ><span class="glyphicon glyphicon-remove"></span></button>
