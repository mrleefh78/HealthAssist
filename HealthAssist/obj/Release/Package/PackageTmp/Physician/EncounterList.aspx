<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EncounterList.aspx.cs" Inherits="HealthAssist.EncounterList" EnableEventValidation="false" %>
    ...
    <section class="content">
        ...
        <div class="row">  </div>
            ...
            <Columns>
                ...
                <asp:BoundField DataField="EncounterNo" HeaderText="Encounter No">
                <HeaderStyle HorizontalAlign="Left" />
                <ItemStyle Width="110px" />
                </asp:BoundField>
                <asp:BoundField DataField="EncounterDate" DataFormatString="{0:d}" HeaderText="Date">
                <HeaderStyle HorizontalAlign="Left" />
                ...
                <asp:BoundField DataField="CompanyName" HeaderText="Insurance Company" />
