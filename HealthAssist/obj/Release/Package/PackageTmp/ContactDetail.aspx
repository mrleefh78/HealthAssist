<%@ Page Title="" Language="C#" MasterPageFile="~/BrightCareAdmin.Master" AutoEventWireup="true" CodeBehind="ContactDetail.aspx.cs" Inherits="HealthAssist.ContactDetail" EnableEventValidation="false"%>
         ...
         <div class="row">  
             ...
             <div class="col-md-3"> 
                  ...
                  <asp:DropDownList ID="ddlFacilityType" class="form-control mr-sm-2" runat="server">
                      ...
                      <asp:ListItem>Car Service</asp:ListItem>
