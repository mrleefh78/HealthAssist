<%@ Page Title="" Language="C#" MasterPageFile="~/BrightCareAdmin.Master" AutoEventWireup="true" CodeBehind="Invoice.aspx.cs" Inherits="HealthAssist.Invoice" EnableEventValidation="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderHeader" runat="server">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><asp:Label ID="ActiveForm" runat="server" Text="Invoices"></asp:Label></li>
      </ol>
    </section>
</asp:Content>
    ...
    <div class="container-fluid" style="margin: 0">
        ...
        <div class="table-responsive">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="CompanyName" HeaderText="Insurance Company Name">
                <HeaderStyle HorizontalAlign="Left" />
                </asp:BoundField>               
                ...
                <asp:BoundField DataField="InvoiceDate" HeaderText="Invoice Date" DataFormatString="{0:d}" />
                 <asp:BoundField DataField="Medex" HeaderText="Medex" />
                  <asp:BoundField DataField="CaseFee" HeaderText="Case Fee" />
                 <asp:BoundField DataField="TotalBilled" HeaderText="Total Billed" />
                  <asp:BoundField DataField="DateBilled" HeaderText="Date Billed" DataFormatString="{0:d}" />
                 <asp:BoundField DataField="DatePaid" HeaderText="Date Paid" DataFormatString="{0:d}" />
