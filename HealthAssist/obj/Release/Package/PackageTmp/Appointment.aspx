<%@ Page Title="" Language="C#" MasterPageFile="~/BrightCareAdmin.Master" AutoEventWireup="true" CodeBehind="Appointment.aspx.cs" Inherits="HealthAssist.Appointment" EnableEventValidation="false"  %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderHeader" runat="server">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><asp:Label ID="ActiveForm" runat="server" Text="Patient Appointment"></asp:Label></li>
      </ol>
    </section>
</asp:Content>
    ...
    <div class="container-fluid" style="margin: 0">
        ...
        <div class="table-responsive">
            ...
            <Columns>
               ...
               <%-- <asp:BoundField DataField="FacilityName" HeaderText="Health Facility">
                <HeaderStyle HorizontalAlign="Left" />
                </asp:BoundField>   --%>                                   
